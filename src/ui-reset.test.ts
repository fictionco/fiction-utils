...
Object.defineProperty(global, 'PopStateEvent', {
...
describe('UIResetManager', () => {
  ...
  describe('browser environment', () => {
    ...
    it('should trigger reset on escape key', () => {
      ...
      const keydownHandler = vi.mocked(global.window.addEventListener).mock.calls
    ...
    it('should trigger reset on window click', () => {
      ...
      const clickHandler = vi.mocked(global.window.addEventListener).mock.calls
    ...
    it('should trigger reset on popstate (back/forward)', () => {
      ...
      const popstateHandler = vi.mocked(global.window.addEventListener).mock.calls
        .find(call => call[0] === 'popstate')?.[1] as EventListener
